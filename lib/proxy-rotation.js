...
// Alternative: Use browser automation for Cloudflare
var USE_BROWSER_FOR_CLOUDFLARE = process.env.USE_BROWSER_MODE === 'true';
var USE_PROXY_FOR_TESTING = false; // Disable proxy since we'll use browser
